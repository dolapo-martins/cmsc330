...
let rec string_of_str_list_list l = match l with
      [] -> ""
    | (h::t) -> (string_of_str_list h) ^ (string_of_str_list_list t)
;;
...
let prt_str_list_list l = print_endline (string_of_str_list_list l)
;;
